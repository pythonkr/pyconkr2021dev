...
const pyconPersons: pyconpersonsType = [
  ...
  {
    name: "강윤수",
    img: "https://2021.pycon.kr/img/personimg/yoonsu.jpg",
    introduce:
      "파이콘을 통해서 모두가 파이썬을 활용할 수 있는 기회가 오길 바라는 Technical Operator 입니다.",
  },
  {
    name: "강종연",
  ...
  },
  {
    ...
    introduce:
      "Errors should never pass silently. Unless explicitly silenced. 세상을 디버깅하고 싶어 civic hacking 하고 있습니다.",
  },
  {
    name: "오주영",
  ...
  },
  {
    ...
    introduce:
      "파이콘이 누군가에게 희망과 기회가 되길바라는 마음으로 참여하고 있습니다.",
  },
  {
    name: "추교영",
  ...
  },
  {
    ...
    introduce:
      "파이썬 뉴비입니다! WomenTechMakers Korea Ambassador로도 활동 중입니다 +ㅁ+",
  },
  {
    name: "홍연의",
    img: "https://2021.pycon.kr/img/personimg/alicehong.jpg",
    introduce:
      "Developer Relations & Tech Communicator. IT 업계에서 개발자 커뮤니티를 위해 일하고 있어요.",
    newlineintro: "인생의 원동력은 일과 사람, 그리고 사랑 ♥︎",
  },
];

export const PyconPersonBlock = styled.div`
  display: flex;
  align-items: center;
...
export const PyconPersonsBlock = styled.div`
  h2 {
    color: #f5df4d;
    font-size: 3rem;
    span {
...
export const PersonIntroBlock = styled.div`
  align-items: center;
  margin: 0 0 1rem 1.7rem;
  flex: 1;
`;

export const PersonNameBlock = styled.h4`
  margin-top: 0;
  margin-bottom: 1rem;
`;
...
export const PersonImage = styled.img`
  ...
  height: 100%;
`;
export const PersonText = styled(TextBlock)`
  font-size: 1.5rem;
`;
  ...
  return (
    <ContentBackgroundBlock>
      <GuideContributeBlock>
        <h2>
          <span>파이콘 한국 2021을 만드는 사람들</span>
        </h2>
        <TextBlock>
          파이콘 한국 준비위원회는 2014년 조직되어, 올해 여덟 번째 한국에서의
          파이콘 행사를 준비하고 있습니다. 준비위원회는 매년 신규 멤버를
          모집하는 파이콘을 사랑하는 사람들의 열린 모임입니다.
        </TextBlock>
        <PyconPersonsBlock>
          <PersonsListTitle>
            준비위원회 명단 {"("}가나다 순{")"}{" "}
        ...
        <PyconPersonsBlock>
          <h2>
            <span>환영하는 분위기를 만들어 주세요</span>
          </h2>
          <TextBlock>
            “파이콘 한국은 커뮤니티 주관으로 이뤄지는 비영리 행사입니다. 파이콘
            한국 준비위원회는 건강한 국내 파이썬 생태계에 지속적인 보탬이
            되고자, 커뮤니티 멤버들의 자발적인 봉사로 운영되고 있습니다. 발표자,
            준비위원회, 참가자 등 모든 인원이 금전적 이득 없이 순수히 오픈소스
            프로그래밍 언어인 파이썬의 저변 확대와 커뮤니티 활성화를 위해
            진행하는 행사입니다.
            <br />
          </TextBlock>
          <TextBlock>
            파이콘 한국 행사 진행과정을 포함하여 모든 의사소통 과정에서 CoC를
            준수하고, 파이콘 한국 준비위원회 가이드를 따라주세요. 파이콘 한국
            준비위원회는 전원 자원봉사로 이루어진 커뮤니티이기에 모든 요청에
            실시간으로 대응하기 어렵습니다.”
          </TextBlock>
          <TextBlock>
            “PyCon Korea is a non-profitable, developer-oriented event organized
            by community members, and has different characteristics from
            conferences organized companies or organizations. All attendees,
            including speakers, tutorial hosts, voluntary workers, and
            organizers, participate in PyCon Korea without any profitable
            purpose, and only to broaden the usage of Python, an open source
            programming language, and activate its community.”
          </TextBlock>
        </PyconPersonsBlock>
      </GuideContributeBlock>
    </ContentBackgroundBlock>
