        ...
        <DetailBenefitsBlock>
            ...
            <AboutbenefitsBlock>
                ...
                <AboutdetailLogoBlock>
                    <h2>1{')'} 발표 영상</h2>
                    <h3>* 대상 후원 등급: 키스톤, 다이아몬드, 플래티넘, 골드, 스타트업, 출판사/미디어/기술 후원</h3>
                    <p>이전과 비슷한 모양새로 파이콘 한국 2021의 모든 발표 영상에 후원사의 로고를 넣을 예정입니다. 해당 영상은 파이콘 한국 2021 행사 기간 뿐만 아니라, 영상이 유튜브에 게시되기 때문에 지속적인 로고 노출 및 홍보 효과를 가져올 예정입니다.</p>
                    <ul>
