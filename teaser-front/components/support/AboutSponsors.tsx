    ...
    return (
        <ContentBackgroundBlock>
            <SupportBlock>
                ...
                <p>- 후원 가능 여부나 기타 문의사항은 언제든지 <a href="mailto:sponsor@pycon.kr">sponsor@pycon.kr</a>로 문의 주시기 바랍니다. </p>
                <p>- 커뮤니티 스폰서십은 비영리 단체에 한해 후원이 가능합니다.</p>
                <p>- 세부 사항은 행사 전까지 다소 변경될 수 있습니다.</p>
                <p>- 출판사 후원의 경우, <strong>파이썬 관련 도서 출판 기록이 필요합니다.</strong></p>
                <p><strong>- 스타트업 스폰서십은 사내에서 파이썬을 사용하고, 설립 2.5년 이하, 사내 인원 15인 이하인 곳에 한합니다.</strong></p>
            </SupportBlock>
        </ContentBackgroundBlock>
    )
}
