...
function ValueOfSponsor() {
    return (
        <ContentBackgroundBlock>
            ...
            <AboutBlock>
                <h1>제품 마케팅</h1>
                <p>개발자를 대상으로 후원사의 서비스와 제품에 대한 다양한 홍보를 할 수 있는 버추얼 부스 / 세션 / 3분 토크 등의 채널을 제공합니다.</p>
            </AboutBlock>
            <AboutBlock>
                <h1>개발자 구인</h1>
            ...
            <AboutBlock>
                <h1>지속적인 로고 노출</h1>
                <p>2021 파이콘 한국 행사 관련 영상에 후원사 로고가 노출되며, 지난 파이콘 한국의 행사 홈페이지에도 지속적으로 보관 및 유지가 됩니다. 파이콘 한국 홈페이지는 개발자뿐만 아니라 관련 업계 종사자에게도 꾸준히 노출이 되고 있는 채널 입니다.</p>
            </AboutBlock>
        </ContentBackgroundBlock>
    )
}
